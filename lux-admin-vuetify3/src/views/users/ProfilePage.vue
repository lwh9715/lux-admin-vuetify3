  ...
  <v-sheet elevation="0" class="mx-auto" color="transparent" max-width="1600">
          ...
          <v-card-text class="pa-7">
            <v-row>
              <v-col cols="12" sm="6">
                ...
                <v-text-field v-model="basic.username" color="primary" variant="outlined" density="compact" type="text" placeholder="John Deo" hide-details />
              </v-col>
              <v-col cols="12" sm="6">
                <v-label class="font-weight-medium mb-2">Realname</v-label>
                <v-text-field v-model="basic.realname" color="primary" variant="outlined" density="compact" type="text" placeholder="John Deo" hide-details />
              </v-col>
              <v-col cols="12" sm="6">
                <v-label class="font-weight-medium mb-2">Email</v-label>
                <v-text-field class="bg-blue-grey-lighten-5" readonly v-model="basic.email" color="primary" variant="outlined" density="compact" type="text" placeholder="John Deo" hide-details /></v-col>
            </v-row>
          </v-card-text>
          <v-divider></v-divider>
          ...
          <v-card-text class="pa-7">
            <v-row>
              <v-col cols="12" sm="6">
                ...
                <v-text-field readonly v-model="passwords.currentPassword" class="bg-blue-grey-lighten-5" density="compact" color="primary" variant="outlined" :type="currentPasswordShow ? 'text' : 'password'" placeholder="Current Password" hide-details :append-inner-icon="currentPasswordShow ? 'mdi-eye' : 'mdi-eye-off'
                    " @click:append-inner="
    ...
    ">
              ...
              <v-col cols="12" sm="6">
                ...
                <v-text-field v-model="passwords.newPassword" density="compact" color="primary" variant="outlined" :type="newPasswordShow ? 'text' : 'password'" placeholder="new password" hide-details :append-inner-icon="newPasswordShow ? 'mdi-eye' : 'mdi-eye-off'
                    " @click:append-inner="newPasswordShow = !newPasswordShow">
                </v-text-field>
              </v-col>
              <v-col cols="12" sm="6">
                <v-label class="font-weight-medium mb-2">Confirm Password</v-label>
                <v-text-field v-model="passwords.confirmPassword" density="compact" color="primary" variant="outlined" :type="confirmPasswordShow ? 'text' : 'password'" placeholder="confirm password" hide-details :append-inner-icon="confirmPasswordShow ? 'mdi-eye' : 'mdi-eye-off'
                    " @click:append-inner="
    ...
    ">
        ...
        <v-card class="mb-5">
          ...
          <v-card-text class="pa-7">
            <div>
              <v-switch v-model="notifications.officialEmails" color="primary" class="mr-4" hide-details label=" Receive newsletters, promotions and news from lux"></v-switch>
            </div>
            <div>
              <v-switch v-model="notifications.followerUpdates" color="primary" class="mr-4" hide-details label=" Notify me when someone I follow uploads new workx"></v-switch>
            </div>
          </v-card-text>
          <v-divider></v-divider>
          <v-card-actions class="pa-5">
